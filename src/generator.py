...
class DataGenerator(Sequence):
    ...
    def __init__(self, batch_size=40, x_shape=(485, 329, 3), y_shape=(1,), n_dataset_items=46652):
        ...
        self.x_filepaths = os.listdir('imdb/')
        self.y_labels = np.genfromtxt('???',dtype='int')
